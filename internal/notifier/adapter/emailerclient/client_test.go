...
func (s *ClientSuite) TestSendConfirmation() {
	s.rpc.On("SendConfirmation", mock.Anything, mock.MatchedBy(func(req *emailerv1.SendConfirmationRequest) bool {
...
func (s *ClientSuite) TestSendReleaseNotificationsSuccess() {
	s.rpc.On("SendReleaseNotifications", mock.Anything,
		mock.MatchedBy(func(req *emailerv1.SendReleaseNotificationsRequest) bool {
