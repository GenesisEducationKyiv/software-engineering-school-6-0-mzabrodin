...
var domainErrorMappings = []struct {
	...
	{github.ErrInvalidRepo, codes.InvalidArgument, "invalid repo format, expected owner/repo"},
	{github.ErrRepoNotFound, codes.NotFound, "repository not found on GitHub"},
